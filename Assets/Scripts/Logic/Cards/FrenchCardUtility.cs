...
namespace Zoca.Logic
{
    ...
    public class FrenchCardUtility: ItalianCardUtility
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static CardPile CreateDeck(int color = 0, bool wildcards = false)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static CardPile CreateDeck(int minValue, int maxValue, int deckColor = 0, bool wildcards = false)
        {
            ...
            if (wildcards)
            {
                ...
                deck.PushCard(new Card(new object[] { BlackWildcard, deckColor }));
                deck.PushCard(new Card(new object[] { RedWildcard, deckColor }));
            }
